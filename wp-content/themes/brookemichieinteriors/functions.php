<?php
/**
 * Brooke Michie Interiors functions and definitions.
 *
...
if ( ! function_exists( 'brooke_michie_interiors_setup' ) ) {
	/**
	 ...
	 * @return void
	 */
	function brooke_michie_interiors_setup() {
		/*
		...
		register_nav_menus(
			array(
                'primary' => esc_html__( 'Primary', 'brooke_michie_interiors' ),
				'footer' => esc_html__( 'Footer', 'brooke_michie_interiors' ),
			)
		);
    }
}
add_action( 'after_setup_theme', 'brooke_michie_interiors_setup' );
 ...
 * @return void
 */
function brooke_michie_interiors_scripts() {
...
add_action( 'wp_enqueue_scripts', 'brooke_michie_interiors_scripts' );
 ...
 * @return array
 */
function brooke_michie_interiors_body_classes( $classes )
{
	/* 
...
add_filter('body_class', 'brooke_michie_interiors_body_classes');
 ...
 */
function brooke_michie_interiors_change_posts_per_page( $query ) {
...
add_filter( 'pre_get_posts', 'brooke_michie_interiors_change_posts_per_page' );
